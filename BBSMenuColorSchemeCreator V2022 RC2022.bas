...
Dim file9 As String ' file9 is reserved for conversion from BBS codes to ascii
...
If pick = 2 Then
    horizontalines = "double": verticalines = "single"
    corner1a = Chr$(37)
    corner2a = Chr$(37) ' corner character for new corners of new box output
    corner3a = Chr$(37)
    corner4a = Chr$(37)
    connector1a = Chr$(37)
    connector2a = Chr$(37) 'various connectors for lines in boxes
    connector3a = Chr$(37)
    connector4a = Chr$(37)
    toplineconnectora = Chr$(37) ' Horizontal line character for new box output
    middlelineconnectora = Chr$(37)
    bottomlineconnectora = Chr$(37)
    rightverticallinea = Chr$(37)
    leftverticallinea = Chr$(37)
End If
If pick = 3 Then
    horizontalines = "single": verticalines = "double"
    corner1a = Chr$(42)
    corner2a = Chr$(42) ' corner character for new corners of new box output
    corner3a = Chr$(42)
    corner4a = Chr$(42)
    connector1a = Chr$(42)
    connector2a = Chr$(42) 'various connectors for lines in boxes
    connector3a = Chr$(42)
    connector4a = Chr$(42)
    toplineconnectora = Chr$(42) ' Horizontal line character for new box output
    middlelineconnectora = Chr$(42)
    bottomlineconnectora = Chr$(42)
    rightverticallinea = Chr$(42)
    leftverticallinea = Chr$(42)
...
If pick = 4 Then
    ...
    corner4a = Chr$(35)
    connector1a = Chr$(35)
    connector2a = Chr$(35) 'various connectors for lines in boxes
    connector3a = Chr$(35)
    connector4a = Chr$(35)
    toplineconnectora = Chr$(35) ' Horizontal line character for new box output
    middlelineconnectora = Chr$(35)
    bottomlineconnectora = Chr$(35)
...
asciidisplay = "c:\display\bbsdisplayascii" + file9
...
If menuchoice = "D" Then
    If b = "@" Then
        If b = "0" Then x = 0: countz1 = 0
        If b = "1" Then x = 1: countz1 = 1
        If b = "2" Then x = 2: countz1 = 2
        If b = "3" Then x = 3: countz1 = 3
        If b = "4" Then x = 4: countz1 = 4
        If b = "5" Then x = 5: countz1 = 5
        If b = "6" Then x = 6: countz1 = 6
        If b = "7" Then x = 7: countz1 = 7
        If b = "8" Then x = 8: countz1 = 8
        If b = "9" Then x = 9: countz1 = 9
        If b = "A" Then x = 10: countz1 = 10
        If b = "B" Then x = 11: countz1 = 11
        If b = "C" Then x = 12: countz1 = 12
        If b = "D" Then x = 13: countz1 = 13
        If b = "E" Then x = 14: countz1 = 14
        If b = "F" Then x = 15: countz1 = 15
    End If
    If b = "0" And countz1 = 0 Then y = 0: countz2 = 1
    If b = "1" And countz1 = 1 Then y = 1: countz2 = 2
    If b = "2" And countz1 = 2 Then y = 2: countz2 = 3
    If b = "3" And countz1 = 3 Then y = 3: countz2 = 4
    If b = "4" And countz1 = 4 Then y = 4: countz2 = 5
    If b = "5" And countz1 = 5 Then y = 5: countz2 = 6
    If b = "6" And countz1 = 6 Then y = 6: countz2 = 7
    If b = "7" And countz1 = 7 Then y = 7: countz2 = 8
    If b = "8" And countz1 = 8 Then y = 8: countz2 = 9
    If b = "9" And countz1 = 9 Then y = 9: countz2 = 10
    If b = "A" And countz1 = 10 Then y = 10: countz2 = 11
    If b = "B" And countz1 = 11 Then y = 11: countz2 = 12
    If b = "C" And countz1 = 12 Then y = 12: countz2 = 13
    If b = "D" And countz1 = 13 Then y = 13: countz2 = 14
    If b = "E" And countz1 = 14 Then y = 14: countz2 = 15
    If b = "F" And countz1 = 15 Then y = 15: countz2 = 16
    If b = "@" And countz2 > 0 Then
        flag = "Yes"
    End If
    countz2 = 0
